  ...
  return (
    <div>
      ...
      <div className="relative flex flex-row mx-12 mt-4">
        <div className="relative flex flex-col w-[100%] mr-12">
          ...
          <div className="flex flex-col my-6 md:flex-row items-center space-x-4 mt-5 w-full">
            <Image
