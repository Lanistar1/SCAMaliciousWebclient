...
interface CardProps {
  ...
  const ReportCard: React.FC<CardProps> = ({ id,name, role, date, title, keywords,activeTab, onViewDetails }) => {
    let goto
    ...
    return (
      // <div className={`bg-[#F2F3F7] shadow-lg p-4 rounded-[15px] w-[475px] ${activeTab === "Approved" ? 'h-[250px]': 'h-[200px]'} space-y-4`}>
        <div className={`bg-[#F2F3F7] shadow-lg p-4 rounded-[15px] w-[475px] h-[200px] space-y-4`}>
        {/* Top Section */}
