...
const DetailsSide = () => {
  ...
  return (
    <section className='pl-24 text-[#3A4756]'>
        ...
        {/* keyword */}
       {show && <div className='flex flex-col justify-between h-full'>
            ...
            <button className='w-[500px] h-[50px] rounded-[5px] bg-[#A52A2A] text-white'>Add Keywords</button>
            </div>  
        </div>}
            ...
            <div className='flex flex-col gap-6'>
                    ...
                    <div>
                        ...
                        <select
                            id="status"
                            value={''}
                            className="mt-1 block w-[500px] h-[50px]  border-[#F3E9E9] rounded-[5px] px-2 border-[1px] shadow-sm  sm:text-sm"
                        >
